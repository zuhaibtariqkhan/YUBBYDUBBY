...
interface AdidasBrowserProps {
  initialMainCategories: CategoryDetail[];
}

export default function AdidasBrowser({ initialMainCategories }: AdidasBrowserProps) {
  ...
  const getCategoryImageUrl = (name: string, slug: string, wcImageSrc?: string) => {
    ...
    if (lowerName.includes("footwear") || lowerSlug.includes("footwear") || lowerName.includes("shoe")) return "/cat-home.png"; // Footwear lifestyle mapping
    if (lowerName.includes("accessory") || lowerSlug.includes("accessory") || lowerName.includes("bag") || lowerName.includes("cap")) return "/cat-accessories.png";
