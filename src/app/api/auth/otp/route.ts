...
export async function POST(req: NextRequest) {
  try {
    ...
    const { action, email, emailOtp, otpToken, purpose } = body;

    console.log("[OTP API] Request action:", action, "email:", email, "purpose:", purpose);
        ...
        ? `
          <div style="background-color: #030303; color: #ffffff; padding: 40px 20px; font-family: sans-serif; max-width: 600px; margin: 0 auto; border-radius: 16px; border: 1px solid #1a1a1a;">
            ...
            <div style="padding: 0 10px; line-height: 1.6; font-size: 14px; color: #dddddd;">
              <p style="margin-top: 0; font-weight: bold; color: #ffffff; font-size: 16px;">Passcode Recovery Request</p>
              
              <p style="color: #aaaaaa; margin-bottom: 25px;">We received a request to reset the password for your Yubby Dubby account. Use the verification code below to authorize your password rotation.</p>
              
              <div style="text-align: center; margin: 30px 0;">
                <span style="font-size: 10px; font-weight: bold; letter-spacing: 2px; color: #888888; display: block; margin-bottom: 8px; text-transform: uppercase;">Reset Authorization Code</span>
              ...
              <div style="border-top: 1px solid #1a1a1a; padding-top: 20px; font-size: 12px; color: #888888;">
                <p style="margin: 0 0 4px 0; font-weight: bold; color: #ffffff;">Stay secure,</p>
